%% SIS_t with update the interlinkse every step

function [distribution1,distribution2,sum_fail1,sum_fail2]=SIS_t(G1,beta1,delta1,G2,beta2,delta2,G12,a,b,threshold,t_max,k1,k2)
...
for i=1:1:index
    ...
    for t=2:1:t_max+1
       ...
       %     sum_failure2(t)=length(pre_fail2);
        ...
        %%% update the G12 using the algorithm in allocate_interlinks
        G12=allocate_interlinks(failure_index1(end,:),failure_index2(end,:),k1,k2);
